...
class Attr {
  ...
  compile() {
    ...
    } else if (this.name.isSlyElement()) ; else {
...
class Entry {
  ...
  compile() {
    ...
    if (this.entry.type === 'tag') {
      ...
      output += new Attr$1(this.entry.data, this.compiler).compile();
    }
